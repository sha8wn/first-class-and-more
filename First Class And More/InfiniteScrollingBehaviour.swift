...
public struct CollectionViewConfiguration {
	...
	public let carouselMode: Bool
    public var layoutType: LayoutType
	public static let `default` = CollectionViewConfiguration(layoutType: .numberOfCellOnScreen(5), scrollingDirection: .horizontal, carouselMode: false)
    
	public init(layoutType: LayoutType, scrollingDirection: UICollectionView.ScrollDirection, carouselMode: Bool) {
...
public class InfiniteScrollingBehaviour: NSObject {
	...
	private weak var carouselTimer: Timer?
	private let carouselWaitTime = 6
	...
	@objc private func carouselTick() {
		...
		collectionView.setContentOffset(CGPoint(x: collectionView.contentOffset.x + width, y: collectionView.contentOffset.y), animated: true)
	}
}
...
extension InfiniteScrollingBehaviour: UICollectionViewDelegateFlowLayout {
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
		...
		if collectionConfiguration.carouselMode {
			invalidateTimer()
		}
    }
